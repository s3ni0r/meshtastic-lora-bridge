...
`.claude/skills/*/SKILL.md` — plain markdown, readable by any agent.
...
- `.claude/skills/flash-t1000e/SKILL.md` — flashing every path + wedged-board recovery
- `.claude/skills/bench-verify/SKILL.md` — running/extending the hardware regression suite
- `.claude/skills/deploy-ios/SKILL.md` — build → install on iPhone → TestFlight
- `.claude/skills/firmware-release/SKILL.md` — edit → sync → build flavors → cut a release
